...
import { TEMPLATES, SIZE_PRESETS } from '../renderer.js'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const currentSize = computed(() => {
      const preset = SIZE_PRESETS.find(s => s.value === sizePreset.value)
    ...
    function proceed() {
      ...
      emit('update', { template: template.value, sizePreset: sizePreset.value, width: w, height: h })
      emit('next')
    }
