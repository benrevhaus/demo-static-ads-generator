...
;(function() {
  ...
  window.AdGen.Step3Content = defineComponent({
    name: 'Step3Content',
    props: { data: Object },
    ...
    setup(props, { emit }) {
      ...
      const headLen = computed(function() { return headline.value.length })
      const bodyLen = computed(function() { return body.value.length })
